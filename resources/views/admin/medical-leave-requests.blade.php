                                    ...
                                    <tbody>
                                        @foreach ($leaveRequests as $request)
                                            <tr>
                                                ...
                                                <td>@if(isset($request->document->path))<a class="btn btn-primary" target="_blank" href="{{asset($request->document->path ?? '')}}">View File</a>@endif</td>
                                                <td>
                                                    <button class="remove-element btn btn-danger px-2 py-1" title="Delete Leave" data-id="{{ $request->id }}" ><i data-feather="trash-2"></i></button>
                                                </td>
                                                {{-- <td>
...
<!-- Delete -->
<script>
    $("#datatable-tabletools").on("click", ".remove-element", function(e) {
        e.preventDefault();
        swal({
